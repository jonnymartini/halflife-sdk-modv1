...
void EV_FireGlock3(event_args_t* args)
{
	int idx;
	Vector origin;
	Vector angles;
	...
	{
		EV_MuzzleFlash();
		gEngfuncs.pEventAPI->EV_WeaponAnimation(empty ? GLOCK_SHOOT_EMPTY_S : GLOCK_SHOOT_S, 0);
...
void EV_FireGlock4(event_args_t* args)
{
	int idx;
	Vector origin;
	Vector angles;
